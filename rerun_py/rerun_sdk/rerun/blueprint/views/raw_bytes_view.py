...
# Based on "crates/store/re_sdk_types/definitions/rerun/blueprint/views/raw_bytes.fbs".
...
class RawBytesView(View):
    """
    **View**: A view of a single binary piece of data, for use with [`archetypes.RawBytes`][rerun.archetypes.RawBytes].

...
# You can extend this class by creating a "RawBytesExt" class in "raw_bytes_ext.py".
...
class RawBytes(Archetype, VisualizableArchetype):
    ...
    **Archetype**: A chunk of raw bytes.
    ...
    def __init__(self: Any, blob: datatypes.BlobLike) -> None:
        """
        Create a new instance of the RawBytes archetype.
        ...
        # You can define your own __init__ function as a member of RawBytesExt in raw_bytes_ext.py
        with catch_and_log_exceptions(context=self.__class__.__name__):
            self.__attrs_init__(blob=blob)
            return
    ...
    @classmethod
    def _clear(cls) -> RawBytes:
        """Produce an empty RawBytes, bypassing `__init__`."""
    ...
    def visualizer(self, *, mappings: list[VisualizerComponentMappingLike] | None = None) -> Visualizer:
        ...
        """
        return Visualizer("RawBytes", overrides=self.as_component_batches(), mappings=mappings)
